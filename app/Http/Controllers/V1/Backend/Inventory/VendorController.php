...
use App\DataTables\ManageProductVendor;
...
class VendorController extends Controller
{
    ...
    public function show(VendorProductDataTable $dataTable, $id)
    {
        ...
        $managed_by_vendorProducts = Product::where('vendor_id', $id)->where('product_managed_by', 'managed_by_vendor')->with('media')->get();
        $managed_by_giftpokeProducts = Product::where('vendor_id', $id)->where('product_managed_by', 'managed_by_giftpoke')->with('media')->get();
        return $dataTable->with('vendor_id', $id)->render('backend.vendors.show', compact('vendors', 'country', 'state', 'managed_by_vendorProducts', 'managed_by_giftpokeProducts'));
    }
