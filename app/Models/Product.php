...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'promotion_start_date', 'promotion_end_date', 'product_stock_owner', 'product_managed_by',
    ...
    {
        return $this->hasOne(FavoriteProduct::class, 'product_id', 'id')->where('user_id',auth()->id());
    }

    // return product cart_product 
    public function inCart()
    {
        return $this->hasOne(Cart::class, 'product_id', 'id')->where('user_id',auth()->id());
    }
}
