            ...
            <div class="col-lg-4 mx-auto">
                <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                    <div class="brand-logo d-flex align-items-center justify-content-center">
                        <img src="{{asset('assets/images/gift_poke_logo.png')}}" alt="logo" />
                    </div>
                    ...
                    <form class="pt-3" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="text-center mt-4 font-weight-light">Don't have an account? <a href="{{'register'}}" class="text-primary font-weight-bold">Sign up as vendor</a></div>
                    </form>
                </div>
            </div>
        </div>
