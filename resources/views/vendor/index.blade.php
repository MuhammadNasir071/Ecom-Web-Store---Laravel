...
<?php 
    $getYear = Carbon\Carbon::parse(auth()->user()->created_at)->format('Y');
?>
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col col-10">
                    <strong>Welcome</strong><h3 class="font-weight-bold" style="color:#4B49AC">{{auth()->user()->first_name.' '. auth()->user()->last_name}}</h3>
                </div class="col col-2  d-flex">
                <div>
                        <span>You joined on {{$getYear}}</span> 
                </div>
            </div>
        </div>
    </div>
