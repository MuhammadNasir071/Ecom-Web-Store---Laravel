            ...
            <div class="body">
                <div class="card d-block" style="border-radius: 20px 20px 0px 0px;">
                    <div class="d-flex justify-content-between align-items-center px-2">
                        ...
                        <div style="margin-left: -7%;">
                            <h3 class="card-title text-center pt-3">{{__('Product')}}</h3>
                        </div>
                        <div></div>
                    </div>
                </div>
                ...
                <div class="card p-2" style="border-radius: 0px 0px 20px 20px;">
                    ...
                    <div class="product-content pt-0">
                        ...
                        <div class="product-category"><span class="font-weight-bold">{{__('Category: ')}}</span>  
                            @if(isset($product['categories']) && $product['categories']->count())
                                @foreach($product['categories'] as $key => $category)
                                    
                                    <span class="pl-1 inner_span inner_second_span">{{ isset($category['allParentCategories']['allParentCategories']['name']) ? $category['allParentCategories']['allParentCategories']['name'] . " > "  : ' ' }} </span>
                                    <span class="inner_span">{{ isset($category['allParentCategories']['name']) ? $category['allParentCategories']['name']. " > ": ' '}} </span>
                                    <span class="pr-1 inner_span inner_forth_span">{{ isset($category['name']) ? $category['name'] : ''}}</span>
