            ...
            <div class="card p-2">
                ...
                <div class="card-body">
                    ...
                    <div id="categories" class="">
                        ...
                        <form class="forms-sample update_unit" method="POST" data-id="{{ $unit->id }}">
                            <div class="row">
                                <div class="col col-6">
                                ...
                                <div class="col col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="code" id="code"
                                            value="{{ isset($unit['code']) ? $unit['code'] : '' }}" placeholder="e.g. kg" />
                                        @error('code')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                <div class="col col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control" name="base_unit"
                                            id="base_unit"
                                            value="{{ isset($unit['base_unit']) ? $unit['base_unit'] : '' }}" />
                                        @error('base_unit')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control input-field sumoSelect_search operator"
                                            id="operator" name="operator">
                                            <option value="">Select an operator if applicable</option>
                                            <option value="*"
                                                {{ isset($unit['operator']) && $unit['operator'] === '*' ? 'selected' : '' }}>
                                                *</option>
                                            <option value="/"
                                                {{ isset($unit['operator']) && $unit['operator'] === '/' ? 'selected' : '' }}>
                                                /</option>
                            ...
                            <div class="row">
                                <div class="col col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control" name="operation_value"
                                            id="operation_value"
                                            value="{{ isset($unit['operation_value']) ? $unit['operation_value'] : ' ' }}" />
                                ...
                                <div class="col col-6 d-flex align-items-center">
                                    <div class="form-group m-0">
                                        <label for="is_active" class="m-0">Is Active?<font color="red">*</font>
                                            </label>
                                        <input type="checkbox" id="is_active" name="is_active" value="1"
                                            {{ isset($unit['is_active']) && $unit['is_active'] == 1 ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
