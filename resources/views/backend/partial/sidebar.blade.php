<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item {{Route::currentRouteName() == 'admin.coupons.index' ? 'active' : (Route::currentRouteName() == 'admin.coupons.create' ? 'active' : (Route::currentRouteName() == 'admin.coupons.show' ? 'active' : (Route::currentRouteName() == 'admin.coupons.edit' ? 'active' : '')))}}">
