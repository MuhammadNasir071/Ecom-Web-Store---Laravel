        ...
        <div class="card p-2">
            <div class="d-flex justify-content-between align-items-center px-2">
                ...
                <div style="margin-left: -7%;">
                    <h3 class="card-title text-center pt-3">{{__('Edit Category')}}</h3>
                </div>
                <div></div>
            </div>
            <div class="card-body">
                ...
                <div id="categories" class="">
                    <form class="forms-sample update_category" method="POST" data-id="{{ $category->id }}">
                        <div class="row">
                            <div class="col col-6">
                                <div class="form-group">
                                    <label for="name">{{__('Category Name')}}<font color="red">*</font></label>
                            ...
                            @while ($parentCategories = $parentCategories->allParentCategories)
                                @php
                                    ...
                                    $dropdown = '<div class="col col-6 category-div"><div class="form-group">
                                            <label for="parent_category">'. (isset($parentCategories->level) && $parentCategories->level == 0 ? "Parent Category" : "Child Category").'</label>
                        ...
                        <button type="submit" class="btn btn-primary mr-2 update_categories_btn">{{__('Update')}}</button>
                    </form>
                </div>
            </div>
        </div>
